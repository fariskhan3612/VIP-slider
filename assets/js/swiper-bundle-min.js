    ...
    function (e) {
      ...
      const i = (e, t, s) => {
        ...
        a ||
          ((a = f(
            "div",
            (
              "swiper-slide-shadow-fobex swiper-slide-shadow-" +
              (s ? "left" : "top")
            ).split(" ")
          )),
          e.append(a)),
      ...
      ne({
        ...
        setTranslate: () => {
          ...
          c.shadow &&
            (p
              ? ((m = t.wrapperEl.querySelector(".swiper-fobex-shadow")),
                m ||
                  ((m = f("div", "swiper-fobex-shadow")),
                  t.wrapperEl.append(m)),
                (m.style.height = `${r}px`))
              : ((m = e.querySelector(".swiper-fobex-shadow")),
                m || ((m = f("div", "swiper-fobex-shadow")), e.append(m))));
          for (let e = 0; e < a.length; e += 1) {
            const t = a[e];
            let s = e;
          ...
          (s.style.transform = `translate3d(0px,0,${g}px) rotateX(${
            ...
            s.style.setProperty("--swiper-fobex-translate-z", `${g}px`);
        },
        setTransition: (e) => {
          ...
          if (
            ...
            t.params.fobexEffect.shadow && !t.isHorizontal())
          ) {
            const t = s.querySelector(".swiper-fobex-shadow");
        ...
        getEffectParams: () => t.params.fobexEffect,
        perspective: () => !0,
        overwriteParams: () => ({
          slidesPerView: 1,
          slidesPerGroup: 1,
